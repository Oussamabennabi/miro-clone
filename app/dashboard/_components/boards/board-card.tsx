...
export const BoardCard = ({ board }: BoardCardProps) => {
  return (
        ...
        <div className="flex group/card cursor-pointer flex-col overflow-hidden  hover:shadow-md shadow-primary/40 transition-all border border-primary/30  rounded-md justify-start gap-2 items-start w-[200px] h-[280px] ">
